...
const experiences = [
  { role: 'Content Creator/Blogger', company: 'Personal', duration: '2024 - Present', desc: 'Writing on Web3 & Cybersecurity.' },
  { role: 'Web Designer', company: 'Freelance', duration: '2025 - Present', desc: 'Designing responsive sites with Tailwind.' },
  { role: 'Desktop App Developer', company: 'Local Projects', duration: '2025 - Present', desc: 'Electron apps for automation.' },
];
